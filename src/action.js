...
const run = async () => {
  try {
    ...
    console.warn(await octokit.request('GET /repos/<owner>/<repo>/git/trees/url_encode(<branch_name>:<parent_path>)', {
      ...oktokitParams,
      branch_name: context.payload.repository.default_branch,
      parent_path: inputPath
    }))
